...
load(file=file.path(clust_dir, paste0(expt_str, "_lineageData2.Rda")))
load(file=file.path(clust_dir, paste0(expt_str, "_none_fq_ruv1_nobio_nobatch_all_merge_10PCadjP03.Rda")))
...
save(HLoneVallDE500, SLoneVallDE500, NLoneVallDE500, file=file.path(DE_dir,paste0(expt_str,"_oneVall500_DE.Rda")))
save(HLpairwiseDE1000, SLpairwiseDE1000, NLpairwiseDE1000, file=file.path(DE_dir,paste0(expt_str,"_pairwise1000_DE.Rda")))
```
...
save(oneVallDE1000, oneVallDE500, file=file.path(DE_dir, paste0(expt_str, "_allCellsOneVAllDE.Rda")))
