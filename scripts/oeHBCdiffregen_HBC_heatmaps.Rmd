...
clus.labels_regen <- loadToEnv(file.path(oeHBCregen_dir, paste0("oeHBCregenWT_PCA.Rda")))[["clus.labels"]]
...
# load combined data
cmobj <- get(load(file.path(clust_dir, paste0(expt_str, "_cmmerged.Rda"))))
