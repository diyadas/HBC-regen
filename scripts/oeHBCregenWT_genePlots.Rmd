...
singleGPlot(nlm2, ListFigure3B, nlclusters2, colpal, "Neuronal2")
singleGPlot(slm2, ListFigure3B, slclusters2, colpal, "Sus2")
singleGPlot(hlm2, ListFigure3B, hlclusters2, colpal, "HBC1-2")

#####-----Figure S4C Gene expression plots
singleGPlot(nlm2, ListFigureS4C, nlclusters2, colpal, "Neuronal2")
singleGPlot(slm2, ListFigureS4C, slclusters2, colpal, "Sus2")
singleGPlot(hlm2, ListFigureS4C, hlclusters2, colpal, "HBC1-2")
