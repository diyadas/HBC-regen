...
cmobj <- mergeClusters(cmobjM, mergeMethod="locfdr", plotType="mergeMethod", cutoff=0.18)

cmobjM <- makeDendrogram(cmobjM,dimReduce="none", ignoreUnassignedVar=TRUE)
cmobjM <- mergeClusters(cmobj, mergeMethod="adjP", plotType="mergeMethod", cutoff=0.07)
...
clus.labels <- clus.labels[names(clus.labels_slingshot)]
