...
```{r}
de_NL <- read.table(paste0("../output/DE/",expt_str,"/NL_DE_oneVall_limma_500.txt"), stringsAsFactors = FALSE)
de_SL <- read.table(paste0("../output/DE/",expt_str,"/SL_DE_oneVall_limma_500.txt"), stringsAsFactors = FALSE)
