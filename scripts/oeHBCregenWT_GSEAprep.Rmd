...
load(file.path(clust_dir, paste0("EWT_none_fq_ruv1_nobio_nobatch_all_merge_10PCadjP03.Rda")))
...
save(cmobj2M, file=file.path(DE_dir, paste0(expt_str,"_finalClusterObject.Rda")))
